...
const api = require('./main/mainget/extra');
const app = express();
...
setTimeout(() => {
  ...
  fs.readFile('acc.json', 'utf8', (err, data) => {
    ...
    const mail = credentials.mail || "Vui lòng điên email vào acc.json";
    const password = credentials.pass || "Vui lòng điền mật khẩu vào acc.json"
